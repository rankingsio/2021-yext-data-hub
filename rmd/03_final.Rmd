...
The trends in the _legal services_ sector follow the global average trends in all industries very well with one notable difference, the average Google Maps views and Google Search views per location are much lower than the global averages. The average Google Maps views in the _legal services_ sector is only `r round(avg_map_views_legalservices/avg_map_views_allindustry *100, 1)`% of the global average. The average Google Search views in the _legal services_ sector is on average only `r round(avg_search_views_legalservices/avg_search_views_allindustry *100, 1)`% of the global average for all industries. Note the logarithmic scale on the y-axis. It is used because it allows for a better comparison of the trends, despite their difference in magnitude.   
...
Contrary to in the _legal services_ sector, we do not see a gap at the onset of the COVID pandemic for the average of all industries. The _Average Google Phone Calls Per Location_ for the legal services sector is only `r round(avg_phone_call_legal/avg_phone_call_all*100,1)`% of the global average.   

The _Average Google Website Clicks Per Location_ for the _legal services_ sector fluctuates similarly to the average for all industries. It is only `r round(avg_website_clicks_legal/avg_website_clicks_all*100,1)`% of the global average.   
